...
from get_features_table import (csv_to_sql, 
...
if __name__ == "__main__":
    ...
    # Create dicts with user's histories of interactions - random max_history=100 interactions per user
    user_hist_dict = build_user_histories(feed_encoded, max_history=100)
